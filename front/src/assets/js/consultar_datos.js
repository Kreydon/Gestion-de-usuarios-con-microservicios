  ...
  <form id="myForm" enctype="multipart/form-data">
    <div class="flex-container2">
      <div class="izquierda"><label for="tipoDocumento">Tipo de Documento:</label>
        <select class="select" id="tipoDocumento" name="tipoDocumento" disabled>
        ...
        <input type="text" id="primerNombre" name="primerNombre" value="primerNombre"
          ...
          pattern="[A-Za-záéíóúÁÉÍÓÚñÑ\s]+"readonly><br>
        ...
        <select class="select" id="genero" name="genero" disabled>
        ...
        <input type="email" id="email" name="email" value="email"
          title="Se requiere un formato tipo email. Ejemplo: example@ejemplo.com" readonly required><br>

        <label for="celular">Celular:</label>
        <input type="tel" id="celular" name="celular" value="123456"
          title="Máximo 10 números, solo se permiten carácteres númericos." required pattern="[0-9]{10}" readonly><br>
      </div>
      <div class="derecha">
